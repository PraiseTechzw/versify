                            ...
                            <TabsContent key={c} value={c} className="mt-6">
                                {poemsInCollection(c).length > 0 ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center h-[50vh] text-center text-muted-foreground">
                                        <h2 className="text-xl font-headline font-semibold text-foreground">No poems in "{c}"</h2>
                                        <p className="mt-2 max-w-sm">You can add poems to this collection from your main library view.</p>
                                    </div>
                                )}
                            </TabsContent>
                        ))}
